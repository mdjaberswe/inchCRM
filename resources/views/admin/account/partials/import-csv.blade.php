	...
	<div class='modal-body perfectscroll'>
		<div class='form-group'>
			<div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
				<p class='para-type-j'>
					Upload your Accounts CSV file with a header row. Make sure the CSV file has columns for all the required fields on Accounts. Download <a>Sample CSV</a>.
				</p>
			...
			<div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
				<div class='full'>
					...
					<div class='inline-input'>
					    <div class='full'><span><input type='radio' name='import_type' value='new' checked> Add new records <i class='c-danger'>(Skip duplicate or existing <strong>account name</strong> rows)</i></span></div>
					    <div class='full'><span><input type='radio' name='import_type' value='update'> Add new and update existing records without overwriting values <i class='fa fa-info-circle' data-toggle='tooltip' data-placement='top' title='Match&nbsp;By:&nbsp;Account&nbsp;Name'></i></span></div>
					    <div class='full'><span><input type='radio' name='import_type' value='update_overwrite'> Add new and update existing records overwriting values <i class='fa fa-info-circle' data-toggle='tooltip' data-placement='top' title='Match&nbsp;By:&nbsp;Account&nbsp;Name'></i></span></div>      
					</div>  
				</div>	
