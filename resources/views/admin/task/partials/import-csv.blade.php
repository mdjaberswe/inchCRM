	...
	<div class='modal-body perfectscroll'>
		<div class='form-group'>
			<div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
				<p class='para-type-j'>
					Upload your Tasks CSV file with a header row. Make sure the CSV file has columns for all the required fields on Tasks. Download <a>Sample CSV</a>.
				</p>
			...
			<div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
				<div class='full'>
					...
					<div class='inline-input'>
					    ...
					    <div class='full'><span><input type='radio' name='import_type' value='update'> Add new and update existing records without overwriting values <i class='fa fa-info-circle' data-toggle='tooltip' data-placement='top' title='Match&nbsp;By:&nbsp;Task&nbsp;Name'></i></span></div>
					    <div class='full'><span><input type='radio' name='import_type' value='update_overwrite'> Add new and update existing records overwriting values <i class='fa fa-info-circle' data-toggle='tooltip' data-placement='top' title='Match&nbsp;By:&nbsp;Task&nbsp;Name'></i></span></div>      
					</div>  
				</div>	
