{!! Form::open(['route' => 'admin.import.post', 'method' => 'post', 'class' => 'form-type-a']) !!}
	<div class='modal-body perfectscroll'>
		...
		<div class='form-group'>
			<div class='col-xs-12'>
				<p class='para-type-j'>Map the source file's column with the appropriate deal fields.</p>

				<div class='alert-note warning'>
					<p>You've to map the <strong>Deal Name</strong>, <strong>Account</strong> mandatory field to start importing data.</p>
				</div>	
			</div>
		</div> <!-- end form-group -->
		        ...
		        <table class='table table-hover middle less-border space'>
		            <thead>
		                <tr>
		                    ...
		                    <th style='width: 220px'>DEAL&nbsp;FIELDS</th>
		                </tr>
		            </thead>
