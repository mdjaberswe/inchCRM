<div class='modal-body perfectscroll'>   
	...
	<div class='form-group'>
		<label for='last_name' class='col-xs-12 col-sm-3 col-md-3 col-lg-3'>Last Name <span class='c-danger'>*</span></label>
	...
	<div class='form-group'>
		<label for='title' class='col-xs-12 col-sm-3 col-md-3 col-lg-3'>Job Title <span class='c-danger'>*</span></label>
	...
	<div class='form-group'>
		<label for='email' class='col-xs-12 col-sm-3 col-md-3 col-lg-3'>Email <span class='c-danger'>*</span></label>
	...
	<div class='form-group'>
		<label for='role' class='col-xs-12 col-sm-3 col-md-3 col-lg-3'>Role <span class='c-danger'>*</span></label>
	...
	@if(isset($form) && $form == 'create')
		<div class='form-group'>
			<label for='password' class='col-xs-12 col-sm-3 col-md-3 col-lg-3'>Password <span class='c-danger'>*</span></label>
		...
		<div class='form-group'>
			<div class='col-xs-12 col-sm-offset-3 col-sm-9 col-md-offset-3 col-md-9 col-lg-offset-3 col-lg-9'>
				<div class='pretty primary smooth'>
					<input type='checkbox' name='send_login_details' checked>
					<label><i class='mdi mdi-check'></i></label>
				</div>
				<p class='para-type-f color-form'>Email login details to this user</p>
			</div>
		</div>
	@endif
</div> <!-- end modal-body -->
