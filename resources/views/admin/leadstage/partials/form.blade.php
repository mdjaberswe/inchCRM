<div class='modal-body perfectscroll'>
    <div class='form-group'>
        ...
        <div class='col-xs-12 col-sm-9 col-md-9 col-lg-9'>
            {!! Form::text('name', null, ['placeholder' => 'Enter lead stage name', 'class' => 'form-control']) !!}
            <span field='name' class='validation-error'></span>
        </div>
    </div> <!-- end form-group -->

    <div class='form-group'>
        <label for='category' class='col-xs-12 col-sm-3 col-md-3 col-lg-3'>Stage Category <span class='c-danger'>*</span></label>
