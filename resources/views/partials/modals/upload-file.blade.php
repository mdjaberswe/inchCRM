<div class='modal-body perfectscroll'>
	<div class='form-group'>
		<div class='col-xs-12 col-sm-12 col-md-12 col-lg-12 dropzone-container'>
			...
			<div id='common-attach' class='dropzone' data-preview='common-attach-preview' data-linked='lead' data-url='{!! route('admin.file.upload') !!}' data-removeurl='{!! route('admin.file.remove') !!}'></div>
